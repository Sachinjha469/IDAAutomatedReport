...
x_pos=(0,1)
barlist=plt.bar(range(len(data)), data,width=0.3,align='center') 
...
data= [[hdescrpcion1,name],[hdescrpcion,school], [hdescrpcion2,grade], [hdescrpcion3,national],[hpartida,score],[hpartida1,avgscore]]
